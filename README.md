...
The Second Wargame OverTheWire suggests is Bandit. Natas teaches the basics of serverside web-security.
...
In the files I will use a ">" to indicate the steps I took to solve the level and my though process I will use a "#" in order to show outsourcing I used to learn and create cheat sheets
